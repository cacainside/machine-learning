...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # Set 'state' as a tuple of relevant datas for the agent        
        type(waypoint)
        state = str(waypoint) + "_"+ str(inputs['light']) + "_" + str(inputs['left']) + "_" + str(inputs['oncoming'])
        return state
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.75, epsilon=1)
    ##############
